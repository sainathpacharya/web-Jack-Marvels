...
export default function AdminInfluencerFormModal({
  value,
  errors,
  onChange,
  onCancel,
  ...
  return (
    <FormModal title="Add Influencer (Admin)" onClose={onCancel}>
      <div className="space-y-3">
        <FormInput value={value.name} onChange={(e) => onChange('name', e.target.value)} placeholder="Influencer name *" error={errors.name} />
      ...
      <FormActions onCancel={onCancel} onSubmit={onSubmit} submitLabel="Add Influencer" submitting={submitting} />
    </FormModal>
  );
}
